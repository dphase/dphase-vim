...
set statusline+=%4*\ %Y\ 
set statusline+=%5*\ %04l/%03c\ 
set statusline+=%2*\ 0x%04.4B\ 
"set statusline+=%1*\ %-16{strftime(\"%Y-%m-%d\ %H:%M\")}\ 
set statusline+=%6*\ %-3m\ 

hi User1 ctermfg=16  ctermbg=248
hi User2 ctermfg=16  ctermbg=131
hi User3 ctermfg=16  ctermbg=223
hi User4 ctermfg=16  ctermbg=32
hi User5 ctermfg=16  ctermbg=149
hi User6 ctermfg=16  ctermbg=251
