...
syn keyword tclRepeat       contained for foreach skipwhite nextgroup=tclForStart
...
syn keyword tclPrimary      contained append incr lappend lset set skipwhite nextgroup=tclVarName
