...
" Line Structure
syn region  mumpsComment        contained start=/;/ end=/$/ contains=mumpsTodo
syn region  mumpsTodo   	contained start=/TODO/ start=/XXX/ start=/FIX/ end=/;/ end=/$/
...
syn region  mumpsCmd		contained oneline start=/[A-Za-z]/ end=/[ \t]/ end=/$/ contains=mumpsCommand,mumpsPostCondition,mumpsError nextgroup=mumpsArgsSeg
...
syn match   mumpsIntrinsic 	contained /$[%A-Za-z][A-Za-z0-9]*/ contains=mumpsIntrinsicFunc,mumpsSpecialVar nextgroup=mumpsParams
