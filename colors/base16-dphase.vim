...
call <sid>hi("SignColumn",    s:gui03, s:guiSC, s:cterm03, s:cterm01, "")
call <sid>hi("SpecialKey",    s:gui03, "", s:cterm03, "", "")
...
call <sid>hi("CursorLineNr",  s:gui04, s:gui02, s:cterm03, s:cterm01, "")
...
call <sid>hi("GitGutterAdd",          s:gui0B, s:guiSC, s:cterm0B, s:cterm01, "")
call <sid>hi("GitGutterChange",       s:gui0C, s:guiSC, s:cterm0D, s:cterm01, "")
call <sid>hi("GitGutterDelete",       s:guiER, s:guiSC, s:cterm08, s:cterm01, "")
call <sid>hi("GitGutterChangeDelete", s:gui0A, s:guiSC, s:cterm08, s:cterm01, "")
